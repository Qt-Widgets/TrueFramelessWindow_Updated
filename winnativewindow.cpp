...
WinNativeWindow::WinNativeWindow(LPCWSTR title, const int x, const int y,
  ...
  hWnd = CreateWindow(L"WindowClass", title, aero_borderless, x, y, width,
                      height, 0, 0, hInstance, nullptr);
  if (!hWnd) {
...
int WinNativeWindow::getMinimumWidth() { return minimumSize.width; }

int WinNativeWindow::getMinimumHeight() { return minimumSize.height; }
...
int WinNativeWindow::getMaximumWidth() { return maximumSize.width; }

int WinNativeWindow::getMaximumHeight() { return maximumSize.height; }
